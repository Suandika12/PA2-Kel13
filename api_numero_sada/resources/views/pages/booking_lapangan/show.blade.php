                                    ...
                                    <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                        ...
                                        <tbody class="fw-semibold text-gray-600">
                                            ...
                                            <tr>
                                                ...
                                                <td class="fw-bold text-end">{{$bookingLapangan->created_at}}</td>
                                            </tr>
                                            <!--end::Date-->
                                            ...
                                            <tr>
                                                ...
                                                <td class="fw-bold text-end">{{$bookingLapangan->opsi_pembayaran}}
                                                </td>
                                            </tr>
                                            <!--end::Payment method-->
                                            <!--begin::Date-->
                                                ...
                                                <table class="table align-middle table-row-bordered mb-0 fs-6 gy-5 min-w-300px">
                                                    ...
                                                    <tbody class="fw-semibold text-gray-600">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="fw-bold text-end">
                                                                <a href="../../demo8/dist/apps/user-management/users/view.html"
                                                                    class="text-gray-600 text-hover-primary">{{ $user->start_play }}</a>
                                                            </td>
                                                        </tr>
                                                        <!--end::Payment method-->
                                                        <!--begin::Date-->
                                                        <tr>
                                                            ...
                                                            <td class="fw-bold text-end">{{ $user->start_play }}</td>
                                                        </tr>
                                                        <!--end::Date-->
                                                    </tbody>
                                                    <!--end::Table body-->
